...
public class Demo2 {
	...
	public static void main(String[] args) throws PcapNativeException, NotOpenException {
		...
		String strType = "43"; // 3(DESTINATION_UNREACHABLE) or 11(TIME_EXCEEDED) or 12(PARAMETER_PROBLEM)
		String strCode = "1";
		...
		byte[] srcMac = new byte[]{0x30,0x38,0x3A,0x30,0x30,0x3A,0x32,0x37,0x3A,0x32,0x31,0x3A,0x64,0x34,0x3A,0x61,0x65};
		byte[] dstMac = new byte[]{0x30,0x38,0x3A,0x30,0x30,0x3A,0x32,0x37,0x3A,0x37,0x62,0x3A,0x65,0x36,0x3A,0x62,0x66};
